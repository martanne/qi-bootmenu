...
INCS = $(shell pkg-config ${PKG_CONFIG_FLAGS} --cflags eina evas ecore ecore-evas)
...
LIBS = -lc -leina $(shell pkg-config ${PKG_CONFIG_FLAGS} --libs eina evas ecore ecore-evas)
